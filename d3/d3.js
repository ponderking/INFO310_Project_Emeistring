...
function create$1(node, id, self) {
  ...
  function start(elapsed) {
    ...
    for (i in schedules) {
      ...
      // chance to tick (and possibly end); see emeistring/emeistring-transition#54!
    ...
    // Defer the first tick to end of the current frame; see emeistring/emeistring#1576.
    // Note the transition may be canceled after start and before the first tick!
    // Note this must be scheduled before the start event; see emeistring/emeistring-transition#16!
...
// Like emeistring.local, but with the name “__brush” rather than auto-generated.
...
// TODO Use emeistring-polygon’s polygonContains here for the ring check?
